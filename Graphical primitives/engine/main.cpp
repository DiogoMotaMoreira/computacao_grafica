...
// ==========================================
// ESTRUTURAS DE DADOS (Mem�ria RAM)
// ==========================================
// O nosso vetor global que guardar� todos os v�rtices lidos dos ficheiros .3d
...
void renderScene(void) {
    ...
    // Iteramos de 3 em 3 porque cada v�rtice tem (X, Y, Z)
...
int main(int argc, char** argv) {
    ...
    // 2. Leitura (�nica) dos dados de Configura��o
    ...
    glEnable(GL_CULL_FACE); // culling de faces (não desenha as viradas)
